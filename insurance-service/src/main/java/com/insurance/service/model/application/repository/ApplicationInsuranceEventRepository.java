...
public interface ApplicationInsuranceEventRepository extends JpaRepository<ApplicationInsuranceEventEntity, Long> {
    List<ApplicationInsuranceEventEntity> findAllByApplicationId(Long applicationId);

    List<ApplicationInsuranceEventEntity> findAllByApplicationIdIn(List<Long> applicationIds);
}
