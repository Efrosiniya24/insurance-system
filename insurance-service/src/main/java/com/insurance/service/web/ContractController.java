...
public class ContractController {
    ...
    @PreAuthorize("hasAnyAuthority('POLICYHOLDER', 'UNDERWRITER')")
    @GetMapping("/all")
    public ResponseEntity<List<ContractDto>> getContracts(final @CurrentUser AuthenticatedUserDto currentUser) {
        return ResponseEntity.ok(contractService.getContractList(currentUser));
    }
}
